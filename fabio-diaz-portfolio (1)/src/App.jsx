...
/* Acento secundario neutro — evita que el rojo vino cargue con marca,
   disponibilidad y numeración a la vez. Solo se usa en la numeración. */
const ACCENT_SECONDARY = "#4A5A46";
...
/* ============================================================ */
/* ⚠️ ANTES Y DESPUÉS — TODAS SON FOTOS DE MUESTRA (UNSPLASH)     */
/* Ninguna de estas 6 parejas es trabajo real de retoque de Fabio.*/
/* Antes de publicar el sitio, CADA "before" y CADA "after" debe   */
/* reemplazarse por una foto real, propia, de un retoque real.    */
/* Publicar esto tal cual sería mostrar trabajo que no es tuyo.   */
/* ============================================================ */

/* Este par vive en el HERO, no en la sección de abajo. */
const heroTransformation = {
  id: 100,
  title: "Grading editorial",
  before: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=1400&q=80",
  after: "https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=1400&q=80",
};

/* Estos 6 van en la sección "Antes y Después" del sitio. */
const transformationPairs = [
  ...
  {
    id: 103,
    title: "Corrección de tono de piel",
    before: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=1200&q=80",
    after: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=1200&q=80",
  },
  {
    id: 104,
    title: "Limpieza de fondo y detalle",
    before: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=1200&q=80",
    after: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=1200&q=80",
  },
  {
    id: 105,
    title: "Balance de blancos",
    before: "https://images.unsplash.com/photo-1521341957697-b93449760f30?w=1200&q=80",
    after: "https://images.unsplash.com/photo-1524250502761-1ac6f2e30d43?w=1200&q=80",
  },
  {
    id: 106,
    title: "Retoque de retrato",
    before: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=1200&q=80",
    after: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=1200&q=80",
  },
  {
    id: 107,
    title: "Consistencia de color entre tomas",
    before: "https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?w=1200&q=80",
    after: "https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=1200&q=80",
  },
];
...
const process = [
  ...
  { n: "03", title: "Recibes el resultado", text: "En la resolución lista para publicar o imprimir." },
];
  ...
  return (
    <header id="top" className={`${CONTAINER} pt-10 md:pt-14`}>
      <div className="flex items-center justify-between mb-6 text-xs" style={{ color: MUTED }}>
        <span style={KICKER} className="uppercase">Editor de fotos freelance desde 2021</span>
      ...
      <Reveal className="text-center">
        ...
        <p className="max-w-xl mx-auto text-base leading-relaxed mb-6" style={{ color: "#3A3A38" }}>
          Transformo fotografías en imágenes con carácter — piel real, color con intención y una estética que no pasa desapercibida.
        </p>

        {/* Segundo registro tipográfico: una cita destacada, distinta del kicker y del cuerpo */}
        <p
          className="max-w-lg mx-auto text-lg md:text-xl leading-snug mb-8 px-4"
          style={{ ...SERIF_ITALIC, color: INK }}
        >
          "Nunca firmo como el fotógrafo — tu marca sigue siendo tuya."
        </p>
        ...
        <div className="flex justify-center mb-12 md:mb-16">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="btn-primary text-xs uppercase px-7 py-3.5 rounded-full inline-flex items-center gap-2"
            style={{ ...KICKER, backgroundColor: INK, color: "#fff" }}
          >
            Let's Chat
      ...
      {/* La prueba, no la descripción: un antes/después real e interactivo desde el primer segundo */}
      <Reveal delay={120}>
        <BeforeAfterSlider
          before={heroTransformation.before}
          after={heroTransformation.after}
          title={heroTransformation.title}
          aspectClass="aspect-[4/5] sm:aspect-[16/9] md:aspect-[21/9]"
          showTitle={false}
          eager
        />
      </Reveal>
...
/* ============================================================ */
function BeforeAfterSlider({ before, after, title, aspectClass = "aspect-[4/5] md:aspect-[16/10]", showTitle = true, eager = false }) {
  ...
  return (
    <div className="mb-4 last:mb-0">
      ...
      {showTitle && <p className="mt-3 text-sm" style={{ ...SERIF, color: INK }}>{title}</p>}
    </div>
  );
}
        ...
        {services.map((s, i) => (
          <Reveal key={s.n} delay={i * 90}>
            <div className="p-8 h-full service-card transition-colors duration-300" style={{ border: `1px solid ${HAIRLINE}` }}>
              <p className="text-sm mb-3" style={{ ...SERIF_ITALIC, color: ACCENT_SECONDARY }}>{s.n}</p>
