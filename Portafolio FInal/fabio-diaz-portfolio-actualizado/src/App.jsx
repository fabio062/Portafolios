...
const portfolioProjects = [
  // Quinceañera
  { id: 1, category: "Quinceañera", title: "Llegada en carruaje", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953285/Carro1_lvnbzh.jpg" },
  { id: 2, category: "Quinceañera", title: "Sombras del bosque", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953315/Color_Grading_Bosque2_vrcd0x.jpg" },
  { id: 3, category: "Quinceañera", title: "Entre robles", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953315/Color_Grading_Bosque_qkrtlh.jpg" },
  { id: 4, category: "Quinceañera", title: "Luz filtrada", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953320/Color_Grading_Bosque_5_udth2h.jpg" },
  { id: 5, category: "Quinceañera", title: "Escalinata real", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953326/Color_Grading_Palacio_cibdwo.jpg" },
  { id: 6, category: "Quinceañera", title: "Ecos de palacio", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953341/Color_Grading_Palacio2_xfxywq.jpg" },
  { id: 7, category: "Quinceañera", title: "Marea dorada", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953342/Playa1_rirh0y.jpg" },
  { id: 8, category: "Quinceañera", title: "Hojas de otoño", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953342/Otono_bdki1o.jpg" },
  { id: 9, category: "Quinceañera", title: "Atardecer de octubre", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953351/Color_Gradng_Oto_dduyab.jpg" },
  { id: 10, category: "Quinceañera", title: "Flor de primavera", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953353/Primavera1_tusyka.jpg" },
  // Retrato
  { id: 11, category: "Retrato", title: "Luz natural", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953533/Retrato_3_rm3zl5.jpg" },
  { id: 12, category: "Retrato", title: "Mirada", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953534/Retrato_2_ygyaj5.jpg" },
  { id: 13, category: "Retrato", title: "Instante", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953535/Retrato_4_zuhml6.jpg" },
  { id: 14, category: "Retrato", title: "Presencia", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953538/Retrato_6_cwwfgb.jpg" },
  { id: 15, category: "Retrato", title: "Confianza", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953540/Retrato_1_cqvgsw.jpg" },
  { id: 16, category: "Retrato", title: "Silencio", image: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953541/Reatro_5_qus7d0.jpg" },
];
...
const transformationPairs = [
  { id: 101, title: "Retoque de piel y color", before: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953904/Antes_y97akx.jpg", after: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953538/Retrato_6_cwwfgb.jpg" },
  { id: 102, title: "Retoque de retrato", before: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785954182/Antes2_copy_wstnqe.jpg", after: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953541/Reatro_5_qus7d0.jpg" },
];
...
const process = [
  ...
  { n: "03", title: "Recibes el resultado", text: "Entrega en la resolución lista para publicar o imprimir. El tiempo se ajusta según el volumen y la complejidad del proyecto." },
];
    ...
    <header id="top" className={`${CONTAINER} pt-10 md:pt-14`}>
      ...
      <Reveal className="text-center">
        ...
        <p className="text-xs md:text-sm uppercase mb-6" style={{ ...KICKER, color: ACCENT }}>
          Retocador Digital · Piel · Color · Composición
        </p>

        <p className="max-w-xl mx-auto text-base leading-relaxed mb-8" style={{ color: "#3A3A38" }}>
          Retoco el trabajo de fotógrafos y estudios — piel real, color con intención y archivos listos para publicar, respetando tu estilo. Sin firmar como fotógrafo, sin diluir tu marca.
        </p>
...
/* ============================================================ */
/* PORTAFOLIO — mosaico en columnas, sin recortar ninguna foto    */
/* Cada imagen se muestra en su proporción real (w-full h-auto);  */
/* CSS columns arma el mosaico sin forzar alturas ni cropping.    */
/* ============================================================ */
