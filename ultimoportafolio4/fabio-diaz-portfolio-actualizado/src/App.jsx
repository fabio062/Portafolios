...
/* ============================================================ */
/* DATA — Before & After pair featured in the hero                */
/* ============================================================ */
const heroTransformation = {
  id: 102,
  title: "Portrait Retouch",
  orientation: "vertical",
  before: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785954182/Antes2_copy_wstnqe.jpg",
  after: "https://res.cloudinary.com/hkzgatvw/image/upload/v1785953541/Reatro_5_qus7d0.jpg",
};
    ...
    <header id="top" className={`${CONTAINER} pt-10 md:pt-14`}>
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center">
        <Reveal className="text-center md:text-left">
          ...
          <p className="max-w-xl mx-auto md:mx-0 text-base leading-relaxed mb-8" style={{ color: "#3A3A38" }}>
          ...
          <div className="flex justify-center md:justify-start">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-primary text-xs uppercase px-6 py-3 rounded-full inline-flex items-center gap-2"
              style={{ ...KICKER, backgroundColor: INK, color: "#fff" }}
            >
              Let's Chat
        ...
        <Reveal delay={120}>
          <BeforeAfterSlider
            ...
            orientation={heroTransformation.orientation}
          />
        </Reveal>
      </div>

      <div className="mt-12 md:mt-16" style={{ borderTop: `1px solid ${HAIRLINE}` }} />
    </header>
  );
}
